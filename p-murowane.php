<?php
/* Template Name: p-murowane */
get_header();
?>

<main class="p-murowane p-drewniane pod"> 
...
<?=$text1?>
      ...
      <div> <div class="img2"><img src="/wp-content/uploads/2026/01/podstawa10.png"> <img src="/wp-content/uploads/2026/01/podstawa11.png"> <img src="/wp-content/uploads/2026/01/podstawa12.png"></div>  <div class="text">  
<?=$text2?>
     </div>   </div>
...
<div class="text"><?=$html11?></div><div class="img2">
           
   <?php
           if ($i==10 ) {  echo "<img src='/wp-content/uploads/2026/01/podstawa10.png''> <img src='/wp-content/uploads/2026/01/podstawa11.png''> <img src='/wp-content/uploads/2026/01/podstawa12.png'>"; }  else{  echo "<img src='$img22'>"; }
           ?>           
        </div></li>                                                          
 <?php   }   ?> 
...
<div class="p-drewniane03-wrap pod-wrap ">
 ...
 <section  class="p-przekierowania"  data-aos="zoom-in" data-aos-offset="100" data-aos-duration="400" > 
